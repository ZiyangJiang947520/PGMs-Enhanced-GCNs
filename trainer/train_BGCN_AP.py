...
from model.BGCN import BayesianGCN  # 确保这个是你修改后的BayesianGCN
...
# 初始化模型
model = BayesianGCN(input_dim, hidden_dim, output_dim)  # 使用BayesianGCN模型
...
torch.save(model.state_dict(), 'model_BGCN_AP.pth')