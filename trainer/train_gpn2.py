...
from model.gpn_gcn2 import GPN_GCN_with_CRF  # 确保这个是你修改后的BayesianGCN
...
# 初始化模型
model = GPN_GCN_with_CRF(input_dim, hidden_dim, output_dim)
...
torch.save(model.state_dict(), 'model_gpngcn2.pth')